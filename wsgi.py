...
class Hello(object):
    ...
    #@+others
    #@+node:2015.20150331094055.1733: *3* check
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def check(self, N=15, M=24, P=15):
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150628193102.1: *3* threeDgear
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def threeDgear(self, N=15, M=24, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def mygeartest2(self, N=15, M=24, P=15):
     
        n= int(cherrypy.session.get('n'))
        m= int(cherrypy.session.get('m'))
    ...
    <canvas id="plotarea" width="1200" height="2400"></canvas>
    </body>
    </html>
    '''
